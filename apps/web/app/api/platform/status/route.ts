...
export async function GET(){
 ...
 const response={
  ...
  readiness:{application:true,coreServices:coreReady,externalAdapters:externalReady,liveIrs:false,reason:'Live IRS status remains false until authorized adapters are enabled, configured, tested, and approved.'},
  integrations,
